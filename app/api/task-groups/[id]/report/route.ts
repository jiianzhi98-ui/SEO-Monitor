...
interface RawRow { user_id: string; keyword: string; source: string; search_volume: number; claimed_date: string; operation_type: string | null; final_keyword: string | null; page_url: string | null }
